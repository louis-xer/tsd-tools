...
const savePriceAndTimestamp = async () => {
  const provider = new ethers.providers.JsonRpcProvider(NODE_URL)
  const UNI = new ethers.Contract('0x55b0c2eee5d48af6d2a65507319d20453e9f97b6', UNI_ABI, provider)
  //token0 is ESD
  ...
  const msg = `${price0.toString()} ${price1.toString()} ${_blockTimestampLast}\n`
  console.log(msg)
  fs.appendFileSync('twap/' + '0x55b0c2eee5d48af6d2a65507319d20453e9f97b6', msg)
}
